            ...
            if (st.rettoken() == 0)
            {
                ...
                while (fp1.read((char*)&bk, sizeof(book)) && flag == 0)
                {
                    if (_strcmpi(bk.retbno(), bn) == 0)
                    {
                        ...
                        fp.seekp(pos, ios::cur);
                        fp.write((char*)&st, sizeof(student));
                        cout << "\n\n\t Book issued successfully\n\nPlease Note: Write the current date in backside of your book and submit within 15 days fine after 15 days period";
                        cout << "\n Fine amount Rs. 10 for each day";
                    }
                }
                if (flag == 0)
